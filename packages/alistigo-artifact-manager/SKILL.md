...
| App | Use when |
|-----|----------|
| `@alistigo/artifact-list` | Embed the Alistigo list widget — an interactive, persistent list/checklist powered by AlistigoDocument. Use via @alistigo/artifact-manager. |
...
- [@alistigo/artifact-list](../alistigo-artifact-list/SKILL.md) — Embed the Alistigo list widget — an interactive, persistent list/checklist powered by AlistigoDocument. Use via @alistigo/artifact-manager.
