...
- **alistigo-document-editor:** add ListApplicationService, ListProjector, Result type ([#60](https://github.com/MLKiiwy/europa/pull/60))
- **alistigo-document-editor:** scaffold the document editor package ([89b6687](https://github.com/MLKiiwy/europa/commit/89b6687))
...
- **alistigo-document-editor:** resolve biome lint errors ([69b0859](https://github.com/MLKiiwy/europa/commit/69b0859))
