...
| [`packages/alistigo-features/`](../packages/alistigo-features/) | Gherkin `.feature` files — behavior specs, tags, style guide |
| [`packages/architecture/adrs/`](../packages/architecture/adrs/) | Architecture Decision Records — one file per significant decision |
| [`sdlc.md`](sdlc.md) | AI-augmented SDLC — lifecycle stages, AI touchpoints, human review gates |
