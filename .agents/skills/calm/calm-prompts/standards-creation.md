...
- **Nodes**: `https://calm.finos.org/release/1.2/meta/core.json#/defs/node`
- **Interfaces**: `https://calm.finos.org/release/1.2/meta/core.json#/defs/interface`
- **Relationships**: `https://calm.finos.org/release/1.2/meta/core.json#/defs/relationship`
- **Controls**: `https://calm.finos.org/release/1.2/meta/core.json#/defs/control`
